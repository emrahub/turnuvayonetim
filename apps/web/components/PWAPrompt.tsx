            ...
            <div className="flex-1">
              ...
              <div className="flex space-x-2 mt-3">
                ...
                <button
                  ...
                  className="bg-transparent border border-white text-white px-3 py-1 rounded text-sm hover:bg-white hover:text-green-600 transition-colors"
                >
                  Daha Sonra
                </button>
              </div>
            ...
            <div className="flex-1">
              ...
              <div className="flex space-x-2 mt-3">
                ...
                <button
                  ...
                  className="bg-transparent border border-white text-white px-3 py-1 rounded text-sm hover:bg-white hover:text-purple-600 transition-colors"
                >
                  Hayır
                </button>
              </div>
...
export function PWAStatusBar() {
  const { isOnline, isInstalled, serviceWorkerReady } = usePWA();
...
export function PWAInstallButton({ children, className = '' }: {
